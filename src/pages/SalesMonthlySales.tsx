                        ...
                        {mg.days.map((dg) => {
                          ...
                          return (
                            <div key={dg.date} className="border-b last:border-b-0">
                              {/* 日付ヘッダー */}
                              <div className="px-4 pt-3 pb-1 bg-muted/10">
                              ...
                              {/* 日計（セラピストが2人以上の場合のみ） */}
                              {dg.therapists.length > 1 && (
                                <div className="px-4 py-2.5 bg-muted/20 border-t border-border/40">
                                  <p className="text-[10px] font-semibold text-muted-foreground mb-1">日計</p>
                                  <AmountGrid data={dayTotal} bold />
                                </div>
                              )}
                            </div>
                          );
